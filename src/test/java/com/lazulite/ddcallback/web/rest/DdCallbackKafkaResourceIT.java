...
public class DdCallbackKafkaResourceIT {
    ...
    @Autowired
    private DdCallbackKafkaProducer producer;

    @Autowired
    private DdCallbackKafkaConsumer consumer;
    ...
    @BeforeEach
    public void setup() {
        DdCallbackKafkaResource kafkaResource = new DdCallbackKafkaResource(producer);
    ...
    public void producedMessageHasBeenConsumed() throws Exception {
        restMockMvc.perform(post("/api/dd-callback-kafka/publish?message=test"))
